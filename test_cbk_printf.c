...
#define TEST_CBKPRINTF(pfmt, pout, arg, val) bRet &= test_svsprintf(pout, #pfmt ":" #arg ":" #val, pfmt, (arg) val);
    ...
    TEST_CBKPRINTF( "%+#23.15e",  " +1.000000000000000e-01"  /* "+7.894561230000000e+008" */ , DOUBLE_ARG, 1.0e-1 );
    TEST_CBKPRINTF( "%+#23.15e",  " +3.900000000000000e+00"  /* "+7.894561230000000e+008" */ , DOUBLE_ARG, 3.9 );
    TEST_CBKPRINTF( "%+#23.14e",  " +7.89456123000000e-307" /* "+7.894561230000000e+008" */ , DOUBLE_ARG, 7.89456123e-307 );
    TEST_CBKPRINTF( "%+#23.14e",  " +7.89456123000000e+307" /* "+7.894561230000000e+008" */ , DOUBLE_ARG, 7.89456123e+307 );
    TEST_CBKPRINTF( "%+#23.15e",  " +7.894561230000000e+08" /* "+7.894561230000000e+008" */ , DOUBLE_ARG, 789456123.0 );
    TEST_CBKPRINTF( "%-#23.15e",  "7.894561230000000e+08  " /* "7.894561230000000e+008 " */, DOUBLE_ARG, 789456123.0 );
    TEST_CBKPRINTF( "%#23.15e",   "  7.894561230000000e+08"  /* " 7.894561230000000e+008" */, DOUBLE_ARG,789456123.0 );
    TEST_CBKPRINTF( "%#1.1g",     "8.e+08"  /* "8.e+008" */ , DOUBLE_ARG, 789456123.0 );
    TEST_CBKPRINTF( "%+#23.15Le",  " +1.000000000000000e-01"  /* "+7.894561230000000e+008" */ , LONG_DOUBLE_ARG, 1.0e-1 );
    TEST_CBKPRINTF( "%+#23.15Le",  " +3.900000000000000e+00"  /* "+7.894561230000000e+008" */ , LONG_DOUBLE_ARG, 3.9 );
    TEST_CBKPRINTF( "%+#23.14Le",  " +7.89456123000000e-307" /* "+7.894561230000000e+008" */ , LONG_DOUBLE_ARG, 7.89456123e-307 );
    TEST_CBKPRINTF( "%+#23.14Le",  " +7.89456123000000e+307" /* "+7.894561230000000e+008" */ , LONG_DOUBLE_ARG, 7.89456123e+307 );
    TEST_CBKPRINTF( "%+#23.15Le",  " +7.894561230000000e+08" /* "+7.894561230000000e+008" */ , LONG_DOUBLE_ARG, 789456123.0 );
    TEST_CBKPRINTF( "%-#23.15Le",  "7.894561230000000e+08  " /* "7.894561230000000e+008 " */, LONG_DOUBLE_ARG, 789456123.0 );
    TEST_CBKPRINTF( "%#23.15Le",   "  7.894561230000000e+08"  /* " 7.894561230000000e+008" */, LONG_DOUBLE_ARG, 789456123.0 );
    TEST_CBKPRINTF( "%#1.1Lg",     "8.e+08"  /* "8.e+008" */ , LONG_DOUBLE_ARG, 789456123.0 );
    ...
    TEST_CBKPRINTF( "%_1I64d",    "" /* "_1I64d" */,         ULONGLONG_ARG, 100 );
    ...
    TEST_CBKPRINTF( "%I",           "" /* "I" */,   INT_ARG, 1 );
    TEST_CBKPRINTF( "%Iq",          "" /* "Iq" */,  INT_ARG, 1 );
    TEST_CBKPRINTF( "%Ihd",         "" /* "Ihd" */, INT_ARG, 1 );
    TEST_CBKPRINTF( "%I0d",         "" /* "I0d" */, INT_ARG, 1 );
    TEST_CBKPRINTF( "%I64D",        "" /* "D" */,   ULONGLONG_ARG, -1 );
    TEST_CBKPRINTF( "%zx",          "1",   SIZE_T_ARG, 1 );
    TEST_CBKPRINTF( "%z",           "" /* "z" */,   SIZE_T_ARG, 1 );
    TEST_CBKPRINTF( "%tx",          "1",   PTRDIFF_T_ARG, 1 );
    TEST_CBKPRINTF( "%t",           "" /* "t" */,   PTRDIFF_T_ARG, 1 );
    TEST_CBKPRINTF( "% d",          " 1",  INT_ARG, 1 );
    TEST_CBKPRINTF( "%+ d",         "+1",  INT_ARG, 1 );
    TEST_CBKPRINTF( "%S",           "wide", PWCHAR_ARG, L"wide" );
    TEST_CBKPRINTF( "%04c",         "   1" /* "0001" */, INT_ARG, '1' );
    ...
    TEST_CBKPRINTF( "%04s",          " foo" /* "0foo" */, PCHAR_ARG, "foo" );
    TEST_CBKPRINTF( "%.1s",          "f",           PCHAR_ARG, "foo" );
    TEST_CBKPRINTF( "%.0s",          "",            PCHAR_ARG, "foo" );
    TEST_CBKPRINTF( "hello",         "hello",       NO_ARG, 0 );
    TEST_CBKPRINTF( "%ws",           "" /* "wide" */,        PWCHAR_ARG, L"wide" );
    TEST_CBKPRINTF( "%-10ws",        "" /*"wide      " */,   PWCHAR_ARG, L"wide" );
    TEST_CBKPRINTF( "%10ws",         "" /* "      wide" */,  PWCHAR_ARG, L"wide" );
    TEST_CBKPRINTF( "%#+ -03whlls",  "" /* "wide" */,        PWCHAR_ARG, L"wide" );
    TEST_CBKPRINTF( "%w0s",          "" /* "0s" */,          PWCHAR_ARG, L"wide" );
    TEST_CBKPRINTF( "%w-s",          "" /* "-s" */,          PWCHAR_ARG, L"wide" );
    TEST_CBKPRINTF( "%ls",           "wide",                 PWCHAR_ARG, L"wide" );
    TEST_CBKPRINTF( "%Ls",           "" /* "not wide" */,    PWCHAR_ARG, "not wide" );
    TEST_CBKPRINTF( "%b",            "101010" /* "b" */,     INT_ARG, 42 );
    TEST_CBKPRINTF( "%3c",           "  a",         INT_ARG, 'a' );
    TEST_CBKPRINTF( "%3d",           "1234",        INT_ARG, 1234 );
    TEST_CBKPRINTF( "%3h",           "",            NO_ARG, 0 );
    TEST_CBKPRINTF( "%k%m%q%r%t%v%y%z", "" /* "kmqrtvyz" */, NO_ARG, 0 );
    ...
    TEST_CBKPRINTF( "%2.4e",         "8.6000e+00",    /* "8.6000e+000",   */  DOUBLE_ARG, 8.6 );
    TEST_CBKPRINTF( "% 2.4e",        " 8.6000e+00",   /* " 8.6000e+000",  */  DOUBLE_ARG, 8.6 );
    TEST_CBKPRINTF( "% 014.4e",      " 0008.6000e+00", /* " 008.6000e+000",*/  DOUBLE_ARG, 8.6 );
    TEST_CBKPRINTF( "% 2.4e",        "-8.6000e+00",   /* "-8.6000e+000",  */  DOUBLE_ARG,  -8.6 );
    TEST_CBKPRINTF( "%+2.4e",        "+8.6000e+00",   /* "+8.6000e+000",  */  DOUBLE_ARG, 8.6 );
    ...
    TEST_CBKPRINTF( "%2.4Le",         "8.6000e+00",    /* "8.6000e+000",   */  LONG_DOUBLE_ARG, 8.6 );
    TEST_CBKPRINTF( "% 2.4Le",        " 8.6000e+00",   /* " 8.6000e+000",  */  LONG_DOUBLE_ARG, 8.6 );
    TEST_CBKPRINTF( "% 014.4Le",      " 0008.6000e+00", /* " 008.6000e+000",*/  LONG_DOUBLE_ARG, 8.6 );
    TEST_CBKPRINTF( "% 2.4Le",        "-8.6000e+00",   /* "-8.6000e+000",  */  LONG_DOUBLE_ARG,  -8.6 );
    TEST_CBKPRINTF( "%+2.4Le",        "+8.6000e+00",   /* "+8.6000e+000",  */  LONG_DOUBLE_ARG, 8.6 );
