...
#define TEST_VSPRINTF(pfmt, pout, val) bRet &= test_vsprintf(pout, #pfmt ", " #val " : " #pout , pfmt, val);
    ...
    TEST_VSPRINTF( "%+#23.15Le",    " +1.000000000000000e-01",   (long double) 1.0e-1 );
    TEST_VSPRINTF( "%+#23.15Le",    " +3.900000000000000e+00",   (long double) 3.9 );
    TEST_VSPRINTF( "%+#23.15Le",    " +7.894561230000000e-307",  (long double) 7.89456123e-307 );
    TEST_VSPRINTF( "%+#23.15Le",    " +7.894561230000000e+307",  (long double) 7.89456123e+307 );
    TEST_VSPRINTF( "%+#23.15Le",    " +7.894561230000000e+08",   (long double) 789456123.0 );
    TEST_VSPRINTF( "%-#23.15Le",    "7.894561230000000e+08  ",   (long double) 789456123.0 );
    TEST_VSPRINTF( "%#23.15Le",     "  7.894561230000000e+08",   (long double) 789456123.0 );
    TEST_VSPRINTF( "%#1.1Lg",       "8.e+08",                    (long double) 789456123.0 );
