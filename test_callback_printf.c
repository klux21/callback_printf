...
#define TEST_SVSPRINTF(pfmt, pout, arg) bRet &= test_svsprintf(pout, #pfmt "," #arg, pfmt, arg);
    ...
    TEST_SVSPRINTF( "%.10s!", "Hallo Welt!", (char *) "Hallo Welt");
    TEST_SVSPRINTF( "%.*s!", "Hallo Welt!", (int) 10 ARG("Hallo Welt"));
    TEST_SVSPRINTF( "%.5s%5.4s!", "Hallo Welt!", (char *) "Hallo" ARG("Welt"));
    ...
    TEST_SVSPRINTF( "%+#23.15Le",  " +1.000000000000000e-01", (long double) 1.0e-1 );
    TEST_SVSPRINTF( "%+#23.15Le",  " +3.900000000000000e+00", (long double) 3.9 );
    TEST_SVSPRINTF( "%+#23.14Le",  " +7.89456123000000e-307", (long double) 7.89456123e-307 );
    TEST_SVSPRINTF( "%+#23.14Le",  " +7.89456123000000e+307", (long double) 7.89456123e+307 );
    TEST_SVSPRINTF( "%+#23.15Le",  " +7.894561230000000e+08", (long double) 789456123.0 );
    TEST_SVSPRINTF( "%-#23.15Le",  "7.894561230000000e+08  ", (long double) 789456123.0 );
    TEST_SVSPRINTF( "%#23.15Le",   "  7.894561230000000e+08", (long double) 789456123.0 );
    TEST_SVSPRINTF( "%#1.1Lg",     "8.e+08",                  (long double) 789456123.0 );
    ...
    TEST_SVSPRINTF( "%.3a", "-0x6.8dcp-3",  (double)  -1.6e-3 );
    TEST_SVSPRINTF( "%.3A", "-0X6.8DCP-3",  (double)  -1.6e-3 );
    TEST_SVSPRINTF( "%.3La", "-0x6.8dcp-3", (long double)  -1.6e-3 );
    TEST_SVSPRINTF( "%.3LA", "-0X6.8DCP-3", (long double)  -1.6e-3 );
